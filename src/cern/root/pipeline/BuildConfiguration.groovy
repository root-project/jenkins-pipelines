...
/*AXEL:            [ label: 'slc6-i686', compiler: 'gcc49',   buildType: 'Release', opts: ''                   + ' ' + extraCMakeOptions ],*/
...
/*AXEL:            [ label: 'fedora28',  compiler: 'native',  buildType: 'Release', opts: '-Dpython_version=3' + ' ' + extraCMakeOptions ],*/
